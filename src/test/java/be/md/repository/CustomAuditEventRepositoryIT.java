...
import be.md.config.audit.AuditEventConverter;
import be.md.domain.PersistentAuditEvent;
...
import static be.md.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
