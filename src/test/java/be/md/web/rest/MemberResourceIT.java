...
public class MemberResourceIT {
    ...
    public void createMember() throws Exception {
        ...
        // Create the Member
        restMemberMockMvc.perform(post("/api/members").with(csrf())
        ...
        assertThat(testMember.getInscription()).isEqualTo(DEFAULT_INSCRIPTION);
    }
    ...
    public void updateMember() throws Exception {
        ...
        restMemberMockMvc.perform(put("/api/members").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
        ...
        assertThat(testMember.getInscription()).isEqualTo(UPDATED_INSCRIPTION);
    }
    ...
    public void deleteMember() throws Exception {
        ...
        // Delete the member
        restMemberMockMvc.perform(delete("/api/members/{id}", member.getId()).with(csrf())
